...
export function DecisionController({ district }: DecisionControllerProps) {
  ...
  const generateReport = () => {
    ...
    fetchReport(decision).then(setReport).catch((error) => { console.error(error); setReportError("Report generation failed. Please try again."); }).finally(() => setLoadingReport(false));
  };
